...
const { sendBookNotificationEmail } = require("../middleware/send-email.middleware");
...
// Create a new book and send email notification
const addBook = async (req, res) => {
  try {
    const newBook = await BookModel.create(req.body);

    // Send email notification using middleware
    await sendBookNotificationEmail(newBook);
